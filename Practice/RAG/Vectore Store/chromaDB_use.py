...
if query:
    ...
    #
    # embedding_variable:
    #     The relevant documents retrieved from Chroma.
    #
    # The prompt receives these values and sends the
    # resulting prompt to the LLM.
    result = chainOutput.invoke({
        "query": query,
        "embedding_variable": embedding_variable
    })
    ...
    # ========================================================
    #
    # StrOutputParser has already converted the LLM response
